...
export function generateDateOptions(customCommitDate: Date | null, formatDateFn: typeof formatDate): vscode.QuickPickItem[] {
    const now = new Date();
...
export function generateTimeOptions(formatDateFn: typeof formatDate): vscode.QuickPickItem[] {
    const options: vscode.QuickPickItem[] = [];
    const now = new Date();
